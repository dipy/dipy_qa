...
import matplotlib.animation as sliceanimation
...
class ImageRegistrationFlow(Workflow):
    ...
    def process_image_data(self, static_img, moved_img):
        ...
        value_range = (mean - 0.1*std, mean + 0.09*std)
    ...
    def animate_overlap(self, static_img, moved_img, slice_type, fname):
        ...
        for i in range(74):
           m = overlay_slices(overlay[...,0], overlay[...,1],
        ...
        ani = sliceanimation.FuncAnimation(fig, update, num_slices,
                            blit=True)
        print(sliceanimation.writers.list())

        # Set up formatting for the movie files
        Writer = sliceanimation.writers['ffmpeg']
